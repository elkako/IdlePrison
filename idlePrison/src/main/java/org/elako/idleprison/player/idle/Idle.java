...
public class Idle {
    ...
    private final Rangos permisoCompra;
    private final Rangos permisoMostrar;
    private final boolean isNegro;
    ...
    public Idle(String nombre, Material iconoIdle, int precioTotal, int precioPorNivel, int dineroCantidad,
                int dineroTiempo, Rangos permisoCompra, Rangos permisoMostrar, boolean isNegro, Materiales1 materiales1, Materiales10 materiales10) {
        this.nombre = nombre;
        ...
        this.permisoCompra = permisoCompra;
        this.permisoMostrar = permisoMostrar;
        this.isNegro = isNegro;
        this.materiales1 = materiales1;
        this.materiales10 = materiales10;
    }

    public interface Materiales1{  LinkedList<ItemStack> materiales1(int nivel); }
    public interface Materiales10{ LinkedList<ItemStack> materiales10(int nivel); }
    ...
    public Material getIconoIdle() { return iconoIdle; }

    public int getPrecioTotal() { return precioTotal; }
    public int getPrecioPorNivel() { return precioPorNivel; }

    public int getDineroCantidad() { return dineroCantidad; }
    public int getDineroTiempo() { return dineroTiempo; }

    public Rangos getPermisoCompra() { return permisoCompra; }
    public Rangos getPermisoMostrar() { return permisoMostrar; }

    public boolean isNegro() { return isNegro; }
}
